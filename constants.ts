...
// In a real production app, these would be the corporate office IPs.
// For testing, users can add their own IP here.
export const ALLOWED_ADMIN_IPS = [
  '127.0.0.1', 
  'localhost',
  '::1',
  // Example corporate IPs:
  '203.0.113.1',
  '198.51.100.24',
  '180.211.179.202'
];
...
export const INITIAL_MOCK_DATA: ProductionRecord[] = [
  ...
  { id: '13', field: 'Alpha West', amount: 480, date: '2024-05-03' },
  { id: '14', field: 'Bravo Shore', amount: 330, date: '2024-05-03' },
  { id: '15', field: 'Charlie Deep', amount: 160, date: '2024-05-03' },
  { id: '16', field: 'Delta Heights', amount: 610, date: '2024-05-03' },
  { id: '17', field: 'Echo Flat', amount: 315, date: '2024-05-03' },
  { id: '18', field: 'Foxtrot Valley', amount: 0, date: '2024-05-03' },
];
